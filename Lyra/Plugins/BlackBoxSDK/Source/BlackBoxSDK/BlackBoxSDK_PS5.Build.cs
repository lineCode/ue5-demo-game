...
public class BlackBoxSDKPlatform_PS5 : BlackBoxSDKPlatform
{
    public BlackBoxSDKPlatform_PS5(ReadOnlyTargetRules inTarget, string inPluginDir, string inEngineDirectory) : base(inTarget, inPluginDir, inEngineDirectory)
    {
    ...
    {
        return new List<string>() {
            Path.Combine(PluginDir, "Libs/x64/PS5/BlackBoxSDK-PS5.a"),
        };
    }
    ...
    {
        return new List<string>() {
            "SceCoredump_stub_weak",
            "SceCoredumpStructuredData",
        };
    }
